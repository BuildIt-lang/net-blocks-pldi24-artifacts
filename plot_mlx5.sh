...
set output "scratch/plot_mlx5.ps"
...
plot    "scratch/cdfs_mlx5.txt" using ($0/10):($1/10000) with lines ls 1 title "UDP-Like", \
        ...
        "scratch/cdfs_mlx5.txt" using ($0/10):($4/10000) with lines ls 4 title "Reliable", \
        "scratch/cdfs_mlx5.txt" using ($0/10):($5/10000) with lines ls 5 title "Signalling", \
        "scratch/cdfs_mlx5.txt" using ($0/10):($6/10000) with lines ls 6 title "FullChecksumming", \
        "scratch/cdfs_mlx5.txt" using ($0/10):($7/10000) with lines ls 7 title "ShrunkFields"
